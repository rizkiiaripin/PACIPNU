<template>
  <section id="kontak">
    ...
    <div class="min-h-screen mt-5 py-5 px-4 sm:px-6 lg:px-8 mb-10">
            ...
            <div class="space-y-7 ms-5">
              <div class="flex items-start space-x-5">
                ...
                <div>
                  ...
                  <p class="text-gray-600">
                    Perum Puri Ciawi Kencana Blok J3,<br />
                    Pasirjuni, Kec. Ciawi, Kab. Tasikmalaya,<br />
                    Jawa Barat 46156
                  </p>
                </div>
              </div>
              <div class="flex items-start space-x-5">
                ...
                <div>
                  ...
                  <p class="text-gray-600">rizki@gmail.com</p>
                </div>
              </div>
              <div>
                ...
                <div class="flex space-x-6 ms-6">
                  <a
                    href="https://www.tiktok.com/@tsukuba.indonesia"
                    class="w-10 h-10 flex items-center justify-center bg-black text-white rounded-full hover:bg-gray-900 transition-transform duration-300 transform hover:scale-110"
                    target="__blank"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                  ...
                  ><a
                    ...
                    class="w-10 h-10 flex items-center justify-center bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white rounded-full transition-transform duration-300 transform hover:scale-110"
                    target="__blank"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                  ...
                  ><a
                    ...
                    class="w-10 h-10 flex items-center justify-center bg-green-500 text-white rounded-full hover:bg-green-700 transition-transform duration-300 transform hover:scale-110"
                    target="__blank"
                    ><svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
            ...
            <form class="space-y-6">
              <div>
                ...
                ><input
                  ...
                  name="nama"
                  placeholder="Nama"
                  class="w-full px-4 py-2 mt-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              <div>
